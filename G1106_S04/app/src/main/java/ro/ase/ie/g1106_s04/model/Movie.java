...
public class Movie implements Parcelable {
    ...
    public Movie(String title, Double budget, Date release, Integer duration, GenreEnum genre, ParentalGuidanceEnum pGuidance, Float rating, Boolean watched, String posterUrl, Boolean fav) {
        this.title = title;
        this.budget = budget;
        this.release = release;
        this.duration = duration;
